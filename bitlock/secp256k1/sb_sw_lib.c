...
static const sb_sw_curve_t* sb_sw_curve_from_id(sb_sw_curve_id_t const curve)
{
    switch (curve) {
        ...
        case SB_SW_CURVE_SECP256K1:
			memcpy((unsigned char*)&SB_CURVE_SECP256K1_WRK, (unsigned char*)&SB_CURVE_SECP256K1, sizeof(sb_sw_curve_t) );
		    SB_CURVE_SECP256K1_WRK.p = &SB_CURVE_SECP256K1_P;
			SB_CURVE_SECP256K1_WRK.n = &SB_CURVE_SECP256K1_N;
			SB_CURVE_SECP256K1_WRK.minus_a_r_over_three = &SB_CURVE_SECP256K1_P.p;

            return &SB_CURVE_SECP256K1_WRK;
    }
    // Huh?
    return NULL;
}
